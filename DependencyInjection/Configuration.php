            ...
            ->children()
                ->arrayNode('error_handler')
                    ...
                    ->children()
                        ...
                        ->booleanNode('throw_handler_exceptions')
                            ->defaultFalse()
                            ->info('By default any exception in the handler will be catched and ignored. Set to true to debug connection errors etc.')
                        ->end()
                    ->end()
                ->end()
